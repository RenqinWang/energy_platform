...
OUTPUT_PATH="${BRONZE_KAFKA_OUTPUT_PATH:-hdfs://node1:9000/lake/bronze/bronze_sensor_kafka}"
CHECKPOINT_PATH="${BRONZE_KAFKA_CHECKPOINT_PATH:-hdfs://node1:9000/checkpoints/kafka_to_bronze_kafka_table}"
